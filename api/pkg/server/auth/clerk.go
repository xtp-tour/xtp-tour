	...
	return func(c *gin.Context) {
		...
		if jwk == nil {
			...
			if err != nil {
				...
				c.AbortWithStatusJSON(http.StatusForbidden, api.ErrorResponse{Error: "Unauthorized"})
				return
			}
			...
			if err != nil {
				...
				c.AbortWithStatusJSON(http.StatusInternalServerError, api.ErrorResponse{Error: "Error fetching JWK"})
				return
			}
		}
